...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function getServiceIcon(slug) {
    const iconMap = {
      ...
      doudounes:    `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M9 3h6v3H9z"/><path d="M6 6h12l3 5-2 11H5L3 11l3-5z"/><line x1="6" y1="6" x2="5" y2="22"/><line x1="18" y1="6" x2="19" y2="22"/><line x1="12" y1="6" x2="12" y2="22"/><line x1="3.5" y1="10" x2="20.5" y2="10"/><line x1="4.2" y1="14" x2="19.8" y2="14"/><line x1="4.8" y1="18" x2="19.2" y2="18"/></svg>`,
      cuir:         `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3.5 C9.5 3.5 8 2.5 6 2.5 C4.5 2.5 3.5 4 4 6 C4.5 8 5.5 9.5 5.5 12 C5.5 14.5 4.5 16 4 18 C3.5 20 4.5 21.5 6 21.5 C8 21.5 9.5 20.5 12 20.5 C14.5 20.5 16 21.5 18 21.5 C19.5 21.5 20.5 20 20 18 C19.5 16 18.5 14.5 18.5 12 C18.5 9.5 19.5 8 20 6 C20.5 4 19.5 2.5 18 2.5 C16 2.5 14.5 3.5 12 3.5 Z"/><circle cx="12" cy="7.5" r="1.1" fill="currentColor"/></svg>`,
      rideaux:      `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><line x1="2" y1="3" x2="22" y2="3"/><circle cx="2" cy="3" r="1" fill="currentColor"/><circle cx="22" cy="3" r="1" fill="currentColor"/><path d="M4 3v8c0 0 2.5-1.5 4-8"/><path d="M4 13v8c0 0 2.5-1.5 4-8"/><line x1="3" y1="12" x2="8" y2="12"/><path d="M20 3v8c0 0-2.5-1.5-4-8"/><path d="M20 13v8c0 0-2.5-1.5-4-8"/><line x1="16" y1="12" x2="21" y2="12"/></svg>`,
