...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function getServiceIcon(slug) {
    const iconMap = {
      ...
      cuir:         `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M7 3C9 4.5 10.5 5 12 5C13.5 5 15 4.5 17 3C18.5 4.5 19.5 5 21 5.5C20.5 8 19.5 10 19.5 12C19.5 14 20.5 16 21 18.5C19.5 19 18.5 19.5 17 21C15 19.5 13.5 19 12 19C10.5 19 9 19.5 7 21C5.5 19.5 4.5 19 3 18.5C3.5 16 4.5 14 4.5 12C4.5 10 3.5 8 3 5.5C4.5 5 5.5 4.5 7 3Z"/><circle cx="12" cy="8" r="1.2" fill="currentColor"/></svg>`,
      rideaux:      `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><line x1="2" y1="3" x2="22" y2="3"/><circle cx="2" cy="3" r="1" fill="currentColor"/><circle cx="22" cy="3" r="1" fill="currentColor"/><path d="M4 3v8c2.5 0 5-2.5 5-8"/><path d="M4 13v8c2 0 4-2 4-8"/><line x1="3.5" y1="13" x2="9" y2="13"/><path d="M20 3v8c-2.5 0-5-2.5-5-8"/><path d="M20 13v8c-2 0-4-2-4-8"/><line x1="15" y1="13" x2="20.5" y2="13"/></svg>`,
