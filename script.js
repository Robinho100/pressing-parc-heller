...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function getServiceIcon(slug) {
    const iconMap = {
      ...
      doudounes:    `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M5 2L2 8v12h20V8l-3-6h-3"/><path d="M5 2h3c0 3 2 4.5 4 4.5S16 5 16 2h3"/><line x1="12" y1="6.5" x2="12" y2="20"/><line x1="2" y1="12" x2="22" y2="12"/><line x1="2" y1="16" x2="22" y2="16"/></svg>`,
      cuir:         `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M12 4 C9.5 4 8 3 6 3 C4.5 3 3.5 4.5 4 6.5 C4.5 8.5 5.5 10 5.5 12 C5.5 14 4.5 15.5 4 17.5 C3.5 19.5 4.5 21 6 21 C8 21 9.5 20 12 20 C14.5 20 16 21 18 21 C19.5 21 20.5 19.5 20 17.5 C19.5 15.5 18.5 14 18.5 12 C18.5 10 19.5 8.5 20 6.5 C20.5 4.5 19.5 3 18 3 C16 3 14.5 4 12 4 Z"/><path d="M12 6 C10 6 8.8 5.2 7.2 5.2 C6 5.2 5.2 6.2 5.6 7.8 C6 9.4 6.8 10.6 6.8 12 C6.8 13.4 6 14.6 5.6 16.2 C5.2 17.8 6 18.8 7.2 18.8 C8.8 18.8 10 18 12 18 C14 18 15.2 18.8 16.8 18.8 C18 18.8 18.8 17.8 18.4 16.2 C18 14.6 17.2 13.4 17.2 12 C17.2 10.6 18 9.4 18.4 7.8 C18.8 6.2 18 5.2 16.8 5.2 C15.2 5.2 14 6 12 6 Z" stroke-dasharray="1.5 1.5" stroke-width="1.2" opacity="0.85"/><circle cx="12" cy="8.2" r="0.9" fill="currentColor"/></svg>`,
      rideaux:      `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><line x1="2" y1="3" x2="22" y2="3"/><circle cx="2" cy="3" r="1.2" fill="currentColor"/><circle cx="22" cy="3" r="1.2" fill="currentColor"/><path d="M3 3v18"/><path d="M3 3c3 0 6 3 3 9"/><path d="M3 12c1.5 3 3 6 4 9"/><line x1="2.5" y1="12" x2="6.5" y2="12" stroke-width="2"/><path d="M4.8 4.2c1.2 2 1.8 4.5 1.8 6.8" opacity="0.8"/><path d="M6.2 3.8c0.9 2.2 1.3 4.5 1.3 6.5" opacity="0.8"/><path d="M21 3v18"/><path d="M21 3c-3 0-6 3-3 9"/><path d="M21 12c-1.5 3-3 6-4 9"/><line x1="17.5" y1="12" x2="21.5" y2="12" stroke-width="2"/><path d="M19.2 4.2c-1.2 2-1.8 4.5-1.8 6.8" opacity="0.8"/><path d="M17.8 3.8c-0.9 2.2-1.3 4.5-1.3 6.5" opacity="0.8"/></svg>`,
