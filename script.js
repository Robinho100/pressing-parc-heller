...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function getServiceIcon(slug) {
    const iconMap = {
      ...
      cuir:         `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3c-2 0-3.5 1.5-4 1.5S6.5 3 4.5 3C3 3 2.5 4.5 3 6c.5 1.5 2 3 2 6s-1.5 4.5-2 6c-.5 1.5 0 3 1.5 3 2 0 3.5-1.5 4-1.5s2 1.5 4 1.5 3.5-1.5 4-1.5 2 1.5 3.5 1.5c1.5 0 2-.5 1.5-3-.5-1.5-2-3-2-6s1.5-4.5 2-6c.5-1.5 0-3-1.5-3-2 0-3.5 1.5-4 1.5S14 3 12 3z"/><circle cx="12" cy="7.5" r="1.5"/></svg>`,
