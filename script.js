...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function getServiceIcon(slug) {
    const iconMap = {
      ...
      doudounes:    `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M9 3c0 1.5 1.3 2 3 2s3-.5 3-2"/><path d="M5 7L2 10v10h4v-6h12v6h4V10l-3-3H5z"/><line x1="12" y1="5" x2="12" y2="20"/><path d="M6 10c2-1 4-1 6-1s4 0 6 1"/><path d="M6 14c2-1 4-1 6-1s4 0 6 1"/><path d="M6 18c2-1 4-1 6-1s4 0 6 1"/></svg>`,
