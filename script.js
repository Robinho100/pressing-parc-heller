...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function getServiceIcon(slug) {
    const iconMap = {
      ...
      doudounes:    `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2a3.5 3.5 0 0 0-3.5 3.5V7h7V5.5A3.5 3.5 0 0 0 12 2z"/><path d="M6 7h12l2 4v9a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-9l2-4z"/><line x1="12" y1="7" x2="12" y2="21"/><line x1="6" y1="10.5" x2="18" y2="10.5"/><line x1="6" y1="14" x2="18" y2="14"/><line x1="6" y1="17.5" x2="18" y2="17.5"/></svg>`,
      cuir:         `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3c-2 0-3.5 1.5-4 1.5S6.5 3 4.5 3C3 3 2.5 4.5 3 6c.5 1.5 2 3 2 6s-1.5 4.5-2 6c-.5 1.5 0 3 1.5 3 2 0 3.5-1.5 4-1.5s2 1.5 4.5 1.5 3-1.5 4.5-1.5 2.5 1.5 4 1.5 1.5 0 2-.5 1.5-3-.5-1.5-2-3-2-6s1.5-4.5 2-6c.5-1.5 0-3-1.5-3-2 0-3.5 1.5-4 1.5S14 3 12 3z"/><path d="M12 5.5c-1.3 0-2.3 1-2.7 1s-1.5-.7-2.5-.7c-.7 0-1 1-.7 2 .3 1 1.3 2 1.3 4.2s-1 3.2-1.3 4.2c-.3 1 0 2 .7 2 1 0 1.5-.7 2.5-.7s1.3 1 2.7 1 1.7-1 2.7-1 1.5.7 2.5.7c.7 0 1-1 .7-2-.3-1-1.3-2-1.3-4.2s1-3.2 1.3-4.2c.3-1 0-2-.7-2-1 0-1.5.7-2.5.7s-1.4-1-2.7-1z" stroke-dasharray="1.5 1.5"/></svg>`,
