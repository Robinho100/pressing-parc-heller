...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function getServiceIcon(slug) {
    const iconMap = {
      ...
      chemises:     `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M20.38 3.46L16 6.14V3a1 1 0 0 0-1-1H9a1 1 0 0 0-1 1v3.14L3.62 3.46A1 1 0 0 0 2 4.3v15.2a1 1 0 0 0 1 1h18a1 1 0 0 0 1-1V4.3a1 1 0 0 0-1.62-.84z"/><path d="M12 13V6"/><path d="M15 6l-3 3-3-3"/></svg>`,
      doudounes:    `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M9 3h6v2.5H9z"/><path d="M6 5.5L2 9.5v11h4v-7h12v7h4v-11l-4-4"/><line x1="12" y1="5.5" x2="12" y2="20.5"/><line x1="2" y1="9.5" x2="22" y2="9.5"/><line x1="2" y1="13.5" x2="22" y2="13.5"/><line x1="2" y1="17.5" x2="22" y2="17.5"/></svg>`,
      cuir:         `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2.5c-1 1-2.5 1.5-4 1.5-2 0-3.5-1-4.5 1.5-.5 1.5.5 4 .5 6.5s-1 5-.5 6.5c1 2.5 2.5 1.5 4.5 1.5 1.5 0 3 .5 4 1.5 1-1 2.5-1.5 4-1.5 2 0 3.5 1 4.5-1.5.5-1.5-.5-4-.5-6.5s1-5 .5-6.5c-1-2.5-2.5-1.5-4.5-1.5-1.5 0-3-.5-4-1.5z"/><circle cx="12" cy="7.5" r="1.75"/></svg>`,
      rideaux:      `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><line x1="2" y1="3" x2="22" y2="3"/><circle cx="2" cy="3" r="1" fill="currentColor"/><circle cx="22" cy="3" r="1" fill="currentColor"/><path d="M5 3.5v7.5c2.5 0 4.5-2.5 4.5-7.5H5z"/><path d="M7 4.5c.7 2 1.3 4 1.6 6"/><path d="M8.5 4.5c.4 1.5.8 3 1 4.5"/><line x1="4.5" y1="12.5" x2="9.5" y2="12.5"/><path d="M5 13.5v7.5c1.8 0 3.2-.8 3.8-7.5"/><path d="M19 3.5v7.5c-2.5 0-4.5-2.5-4.5-7.5H19z"/><path d="M17 4.5c-.7 2-1.3 4-1.6 6"/><path d="M15.5 4.5c-.4 1.5-.8 3-1 4.5"/><line x1="14.5" y1="12.5" x2="19.5" y2="12.5"/><path d="M19 13.5v7.5c-1.8 0-3.2-.8-3.8-7.5"/></svg>`,
