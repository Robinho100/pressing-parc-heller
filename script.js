...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function getServiceIcon(slug) {
    const iconMap = {
      ...
      chemises:     `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M20.38 3.46L16 6.14V3a1 1 0 0 0-1-1H9a1 1 0 0 0-1 1v3.14L3.62 3.46A1 1 0 0 0 2 4.3v15.2a1 1 0 0 0 1 1h18a1 1 0 0 0 1-1V4.3a1 1 0 0 0-1.62-.84z"/><path d="M12 14V6"/><path d="M15 6l-3 3.5-3-3.5"/></svg>`,
      doudounes:    `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M9 3h6v2.5H9z"/><path d="M6 5.5L2 9.5v11.5h4v-7h12v7h4V9.5l-4-4"/><line x1="12" y1="5.5" x2="12" y2="21"/><line x1="2" y1="10" x2="22" y2="10"/><line x1="2" y1="14" x2="22" y2="14"/></svg>`,
      cuir:         `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2.5 L14.2 4 C16.5 3.5 18 4 19.2 5.5 C19.8 7.5 18.5 9.5 18.5 12 C18.5 14.5 19.8 16.5 19.2 18.5 C18 20 16.5 20.5 14.2 20 L12 21.5 L9.8 20 C7.5 20.5 6 20 4.8 18.5 C4.2 16.5 5.5 14.5 5.5 12 C5.5 9.5 4.2 7.5 4.8 5.5 C6 4 7.5 3.5 9.8 4 Z"/><circle cx="12" cy="7.5" r="1.5"/></svg>`,
      rideaux:      `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><line x1="2" y1="3" x2="22" y2="3"/><circle cx="2" cy="3" r="0.75" fill="currentColor"/><circle cx="22" cy="3" r="0.75" fill="currentColor"/><path d="M4 4.5v7.5c2.5 0 4.5-2.5 4.5-7.5H4z"/><path d="M5.8 5c.8 2 1.4 4 1.8 6"/><line x1="3.5" y1="13.5" x2="8.5" y2="13.5"/><path d="M4 14.5v6.5c1.8 0 3.5-.8 4.2-6.5"/><path d="M20 4.5v7.5c-2.5 0-4.5-2.5-4.5-7.5H20z"/><path d="M18.2 5c-.8 2-1.4 4-1.8 6"/><line x1="15.5" y1="13.5" x2="20.5" y2="13.5"/><path d="M20 14.5v6.5c-1.8 0-3.5-.8-4.2-6.5"/></svg>`,
