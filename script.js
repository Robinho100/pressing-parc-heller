...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function getServiceIcon(slug) {
    const iconMap = {
      ...
      doudounes:    `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2a2 2 0 0 0-2 2c0 1 1 1.5 2 2"/><path d="M7 6h10l3 3.5v11.5H4V9.5L7 6z"/><line x1="12" y1="6" x2="12" y2="21"/><line x1="4" y1="11" x2="20" y2="11"/><line x1="4" y1="16" x2="20" y2="16"/></svg>`,
      cuir:         `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3c3-1 6 0 7 2.5s-1 4.5-1 6.5 2 4 1 6.5-4 3.5-7 2.5-6 1-7-2.5 1-4.5 1-6.5-2-4-1-6.5S9 2 12 3z"/><circle cx="12" cy="7.5" r="1.5"/></svg>`,
