...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function getServiceIcon(slug) {
    const iconMap = {
      ...
      doudounes:    `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M9 3c0 1.5 1.3 2.5 3 2.5s3-1 3-2.5"/><path d="M6 5.5L2 9v12h4v-7h12v7h4V9l-4-3.5"/><line x1="12" y1="5.5" x2="12" y2="21"/><path d="M6 9.5c2-1 4-1 6-1s4 0 6 1"/><path d="M6 13.5c2-1 4-1 6-1s4 0 6 1"/><path d="M6 17.5c2-1 4-1 6-1s4 0 6 1"/></svg>`,
      cuir:         `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3.5 C9.5 3.5 8 2.2 6 2.2 C4.2 2.2 3.5 3.8 4 5.8 C4.5 7.8 5.8 9.5 5.8 12 C5.8 14.5 4.5 16.2 4 18.2 C3.5 20.2 4.2 21.8 6 21.8 C8 21.8 9.5 20.5 12 20.5 C14.5 20.5 16 21.8 18 21.8 C19.8 21.8 20.5 20.2 20 18.2 C19.5 16.2 18.2 14.5 18.2 12 C18.2 9.5 19.5 7.8 20 5.8 C20.5 3.8 19.8 2.2 18 2.2 C16 2.2 14.5 3.5 12 3.5 Z"/><circle cx="12" cy="7" r="1.2" fill="currentColor"/></svg>`,
      rideaux:      `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><line x1="1.5" y1="3" x2="22.5" y2="3"/><circle cx="2" cy="3" r="1" fill="currentColor"/><circle cx="22" cy="3" r="1" fill="currentColor"/><path d="M4 3v8c0 0 2-1 4.5-8"/><path d="M4 13v8c0 0 2-1 4.5-8"/><line x1="3" y1="13" x2="8.5" y2="13" stroke-width="2"/><path d="M5.5 5c1 2 2 4.5 2.5 7"/><path d="M20 3v8c0 0-2-1-4.5-8"/><path d="M20 13v8c0 0-2-1-4.5-8"/><line x1="15.5" y1="13" x2="21" y2="13" stroke-width="2"/><path d="M18.5 5c-1 2-2 4.5-2.5 7"/></svg>`,
