...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function getServiceIcon(slug) {
    const iconMap = {
      ...
      doudounes:    `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2C9.5 2 8 3.5 8 5.5v1h8v-1C16 3.5 14.5 2 12 2z"/><path d="M8 6.5L3 10.5v10.5h4v-5h10v5h4V10.5l-5-4"/><line x1="12" y1="6.5" x2="12" y2="21"/><circle cx="12" cy="7.5" r="0.75" fill="currentColor"/><path d="M3 11c3-1 6-1 9-1s6 0 9 1"/><path d="M3 15c3-1 6-1 9-1s6 0 9 1"/><path d="M3 19c3-1 6-1 9-1s6 0 9 1"/></svg>`,
      cuir:         `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3c-2 0-3.5 1.5-4 1.5S6.5 3 4.5 3C3 3 2.5 4.5 3 6c.5 1.5 2 3 2 6s-1.5 4.5-2 6c-.5 1.5 0 3 1.5 3 2 0 3.5-1.5 4-1.5s2 1.5 4.5 1.5 3-1.5 4.5-1.5 2.5 1.5 4 1.5 1.5 0 2-.5 1.5-3-.5-1.5-2-3-2-6s1.5-4.5 2-6c.5-1.5 0-3-1.5-3-2 0-3.5 1.5-4 1.5S14 3 12 3z"/></svg>`,
      ...
      couture:      `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><circle cx6" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><line x1="9.8" y1="8.2" x2="20" y2="17"/><line x1="9.8" y1="15.8" x2="20" y2="7"/></svg>`,
