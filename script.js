...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function getServiceIcon(slug) {
    const iconMap = {
      ...
      cuir:         `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M12 4.5 C9.5 4.5 8 3.5 6 3.5 C4.5 3.5 3.5 5 4 7 C4.5 9 5.5 10.5 5.5 12 C5.5 13.5 4.5 15 4 17 C3.5 19 4.5 20.5 6 20.5 C8 20.5 9.5 19.5 12 19.5 C14.5 19.5 16 20.5 18 20.5 C19.5 20.5 20.5 19 20 17 C19.5 15 18.5 13.5 18.5 12 C18.5 10.5 19.5 9 20 7 C20.5 5 19.5 3.5 18 3.5 C16 3.5 14.5 4.5 12 4.5 Z"/><circle cx="12" cy="7.5" r="1" fill="currentColor"/></svg>`,
      rideaux:      `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><line x1="2" y1="3" x2="22" y2="3"/><circle cx="2" cy="3" r="1" fill="currentColor"/><circle cx="22" cy="3" r="1" fill="currentColor"/><path d="M3 3v9c0 0 2.5-1.5 4-9"/><path d="M3 13v8h3.5v-8"/><line x1="2.5" y1="12" x2="7" y2="12"/><path d="M5.5 4.5c1 2 1.8 4.5 1.8 6.5"/><path d="M7 4c0.8 2 1.3 4.2 1.3 6"/><path d="M21 3v9c0 0-2.5-1.5-4-9"/><path d="M21 13v8h-3.5v-8"/><line x1="17" y1="12" x2="21.5" y2="12"/><path d="M18.5 4.5c-1 2-1.8 4.5-1.8 6.5"/><path d="M17 4c-0.8 2-1.3 4.2-1.3 6"/></svg>`,
