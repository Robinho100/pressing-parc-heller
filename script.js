...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function getServiceIcon(slug) {
    const iconMap = {
      ...
      rideaux:      `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="1"/><line x1="2" y1="6" x2="22" y2="6"/><path d="M2 6v14c1 1 3 2 5 2V6H2z"/><path d="M22 6v14c-1 1-3 2-5 2V6h5z"/><circle cx="4" cy="6" r="0.8" fill="currentColor" stroke="none"/><circle cx="20" cy="6" r="0.8" fill="currentColor" stroke="none"/></svg>`,
