...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function getServiceIcon(slug) {
    const iconMap = {
      ...
      cuir:         `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M12 4C9.5 4 8 3 6 3C4.5 3 3.5 4.5 4 6.5C4.5 8.5 5.5 10 5.5 12C5.5 14 4.5 15.5 4 17.5C3.5 19.5 4.5 21 6 21 C8 21 9.5 20 12 20C14.5 20 16 21 18 21C19.5 21 20.5 19.5 20 17.5C19.5 15.5 18.5 14 18.5 12C18.5 10 19.5 8.5 20 6.5C20.5 4.5 19.5 3 18 3C16 3 14.5 4 12 4Z"/><circle cx="12" cy="8" r="1" fill="currentColor"/></svg>`,
      rideaux:      `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><line x1="2" y1="4" x2="22" y2="4"/><path d="M4 4v16"/><path d="M4 4c4 0 4 4 4 8s-4 8-4 8"/><line x1="3" y1="12" x2="8" y2="12"/><path d="M20 4v16"/><path d="M20 4c-4 0-4 4-4 8s4 8 4 8"/><line x1="16" y1="12" x2="21" y2="12"/></svg>`,
